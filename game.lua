...
function scene:create( event )
   ...
   tube1 = display.newRect(display.contentWidth*1.25,coordenadas[math.random (20)], (display.viewableContentWidth / 6), 420 )
   ...
   tube1.myName = "tube1"
   tube2 = display.newRect(display.contentWidth*1.25,tube1.y+520, (display.viewableContentWidth / 6 ), 420 )
   ...
   tube4.myName = "tube4"
   tube5 = display.newRect(display.contentWidth*2.75,coordenadas[math.random (20)], (display.viewableContentWidth / 6), 420 )
   ...
   tube6 = display.newRect(display.contentWidth*2.75,tube5.y+520, (display.viewableContentWidth / 6 ), 420 )
